...
<head>
    ...
    <body>
            ...
            <center><div class="panel panel-info" style="width: 500px;">
                        ...
                        <h3 class="panel-title"><i class="icon-user"></i>Input Data Dosen</h3> 
                        </div>
                        <div class="panel-body">
                         <form name="form1" id="form1" class="form-horizontal row-fluid" action="?page=guru_input" method="POST" >
										...
										<div align="left" class="control-group">
											...
											<div class="controls">
												<input type="text" name="nama" id="nama" placeholder="Nama Dosen" class="form-control span8 tip" required>
											</div>
										</div>
...
<br
        ...
        <div class="footer span-12">
            <div class="container">
              <center> <b class="copyright"><a href=""> UBSI DEWI SARTIKA</a> by kelompok 4 kelas 12.4D.31 </b></center>
            </div>
        </div>
        <script>
